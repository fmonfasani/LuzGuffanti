...
export const services = [
  {
    ...
    description: 'Producción de contenido auténtico para marcas en redes sociales.'
  },
  {
    title: 'Filmmaker',
    description: 'Dirección y producción de videos profesionales para diferentes propósitos.'
  },
  {
    title: 'Edición',
    description: 'Postproducción y edición profesional de videos y fotografías.'
  },
  {
    title: 'Guiones',
    description: 'Desarrollo de guiones y estrategias narrativas para contenido audiovisual.'
  },
  {
    title: 'Estrategias',
    description: 'Planificación estratégica de contenido para maximizar el alcance y engagement.'
  },
];

export const tools = [
  { imageSrc: '/tools-images/iphone.png', name: 'iPhone 17 Pro' },
  { imageSrc: '/tools-images/rode.png', name: 'Micrófono Rode' },
  { imageSrc: '/tools-images/ipad.png', name: 'iPad Pro' },
  { imageSrc: '/tools-images/tripode.png', name: 'Trípode' },
];

export const testimonials = [
  {
    quote: 'Luz transformó completamente nuestra presencia en redes sociales. Su contenido auténtico conectó con nuestra audiencia de una forma que nunca imaginamos.',
    author: 'Cliente A'
  },
  {
    quote: 'Trabajar con Luz fue una experiencia increíble. Su visión artística y profesionalismo se reflejan en cada video que crea.',
    author: 'Cliente B'
  },
  {
    quote: 'La calidad y creatividad de los contenidos que produce Luz son excepcionales. Ha ayudado a nuestra marca a destacar en un mercado competitivo.',
    author: 'Cliente C'
  },
];